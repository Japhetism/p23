    ...
    >
      ...
      {isEmpty ? (
        <div className="flex-1 flex items-center justify-center">
          <CardEmptyState
            title="No retention rate recorded"
            description="We couldn't find any retention rate data for this period. Try adjusting your filters or importing your latest retention."
